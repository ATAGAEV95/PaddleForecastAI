...
async def generate_prompt():
    prompt = """Ты дружелюбный метео-консультант для сап-серфера. Проанализируй прогноз погоды и дай практические рекомендации в разговорном стиле.
    ...
    "В понедельник 10 ноября - идеальный день! Начинай в 11:30, будет 18°C и почти нет ветра. Можно кататься до 14:00 без проблем.
    Во вторник 11 ноября - тоже отлично, но лучше начать в 12:00, когда станет немного теплее. После 15:00 ветер может усилиться.
